									...
									<div class="tabbable panel-tabs">
										...
										<div class="tab-content">
											...
											<div id="panel_tab_example2" class="tab-pane">
												...
												<p>
													<a target="_blank" href="ui_tabs_accordions.php?tabId=panel_tab_example2" class="btn btn-purple">
											...
											<div id="panel_tab_example3" class="tab-pane">
												...
												<p>
													<a target="_blank" href="ui_tabs_accordions.php?tabId=panel_tab_example3" class="btn btn-blue">
														Activate this tab via URL
													</a>
												</p>
											</div>

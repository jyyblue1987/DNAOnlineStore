		...
		<div class="main-container">
				...
				<div class="fullwidthabnner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							<img src="assets/frontend/images/sliders/slidebg1.png"  style="background-color:rgb(246, 246, 246)" alt="slidebg1"  data-bgfit="cover" data-bgposition="left bottom" data-bgrepeat="no-repeat">
							...
							data-start="1000"
							data-easing="easeOutExpo"  >
								<img src="assets/frontend/images/free-woman.png" alt="Image 1">
							</div>
						</li>
						<!-- end: FIRST SLIDE -->
						<!-- start: SECOND SLIDE -->
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							<img src="assets/frontend/images/sliders/slidebg2.png"  style="background-color:rgb(246, 246, 246)" alt="slidebg1"  data-bgfit="cover" data-bgposition="left bottom" data-bgrepeat="no-repeat">
							<div class="caption lft slide_title slide_item_left"
							data-x="0"
							data-y="105"
							data-speed="400"
							...
							data-easing="easeOutBack">
								<img src="assets/frontend/images/sliders/responsive1.png" alt="Image 1">
							</div>
							...
							data-start="1300"
							data-easing="easeOutBack">
								<img src="assets/frontend/images/sliders/responsive2.png" alt="Image 1">
							</div>
							<div class="caption lft"
							data-x="820"
							data-y="140"
							...
							data-start="1600"
							data-easing="easeOutBack">
								<img src="assets/frontend/images/sliders/responsive3.png" alt="Image 1">
							</div>
							<div class="caption lfb"
							data-x="880"
							data-y="160"
							...
							data-start="1900"
							data-easing="easeOutBack">
								<img src="assets/frontend/images/sliders/responsive4.png" alt="Image 1">
							</div>
						</li>
						<!-- end: SECOND SLIDE -->
						<!-- start: THIRD SLIDE -->
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							<img src="assets/frontend/images/sliders/slidebg3.png"  style="background-color:rgb(246, 246, 246)" alt="slidebg1"  data-bgfit="cover" data-bgposition="left bottom" data-bgrepeat="no-repeat">
							<div class="caption lft slide_title slide_item_left"
							data-x="0"
							data-y="105"
							data-speed="400"
							...
							<div class="grid-container animate-group" data-animation-interval="100">
									...
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/frontend/images/image01.jpg" class="img-responsive"/>
								...
								<div class="col-md-3 col-sm-6">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/frontend/images/image02.jpg" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												3 Columns Portfolio
								...
								<div class="col-md-3 col-sm-6">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/frontend/images/image03.jpg" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												2 Columns Portfolio
								...
								<div class="col-md-3 col-sm-6">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/frontend/images/image04.jpg" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Single Project
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div id="carousel" class="flexslider animate-group" data-plugin-options='{"itemWidth": 120, "itemMargin": 5}'>
								<ul class="slides">
									<li>
										<img src="assets/frontend/images/image01.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="assets/frontend/images/image02.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="assets/frontend/images/image03.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="assets/frontend/images/image04.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
									<li>
										<img src="assets/frontend/images/image05.jpg" class="animate" data-animation-options='{"animation":"fadeIn", "duration":"600"}'/>
									</li>
								</ul>
							</div>
						</div>
							...
							<ul class="slides">
								<li>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="assets/frontend/images/logo-1.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="assets/frontend/images/logo-2.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="assets/frontend/images/logo-3.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="assets/frontend/images/logo-4.png" alt="">
									</div>
								</li>
								<li>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive" src="assets/frontend/images/logo-4.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive" src="assets/frontend/images/logo-2.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="assets/frontend/images/logo-5.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-6">
										<img class="img-responsive animate" data-animation-options='{"animation":"fadeIn", "duration":"300"}' src="assets/frontend/images/logo-6.png" alt="">
									</div>
								</li>
							</ul>
						</div>
			...
			<section class="wrapper wrapper-grey">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<img src="assets/frontend/images/iphoneIpad-495x400.png" class="img-responsive animate-if-visible" data-animation-options='{"animation":"tada", "duration":"600"}'>
						</div>
						<div class="col-sm-6">
			...
			<section class="wrapper" style="min-height:400px; background-image: url('assets/frontend/images/photodune-4043508-3d-modern-office-room-l.jpg')" data-stellar-background-ratio="0.8" data-stellar-vertical-offset="-750">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
									...
									<ul class="slides">
											...
											<div class="col-md-12">
												...
												<div class="testimonial-author">
													<div class="img-thumbnail img-thumbnail-small">
														<img src="assets/frontend/images/avatar-1.jpg" alt="">
													</div>
													<p>
										...
										<li>
											<div class="col-md-12">
												...
												<div class="testimonial-author">
													<div class="img-thumbnail img-thumbnail-small">
														<img src="assets/frontend/images/avatar-2.jpg" alt="">
													</div>
													<p>

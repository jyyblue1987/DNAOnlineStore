								...
								<ul class="team-list">
									<li class="col-md-6 col-sm-6">
										<div class="thumbnail">
											...
											<span class="image-overlay"> <i data-original-title="Facebook" data-placement="top" class="tooltips fa fa-facebook circle-icon circle-small"></i> <i data-original-title="Linkedin" data-placement="top" class="tooltips fa fa-linkedin circle-icon circle-small"></i></span>
										</div>
										<h3>Peter Clark</h3>
										<div>
											UI Designer
							...
							<div class="row">
								<ul class="team-list animate-group">
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/team-3.jpg" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/team-4.jpg" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/team-5.jpg" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
											<span class="image-overlay"> <a target="_blank" href="http://www.facebook.com"><i data-original-title="Facebook" data-placement="top" class="tooltips fa fa-facebook circle-icon circle-small"></i></a> <a target="_blank" href="http://www.linkedin.com"><i data-original-title="Linkedin" data-placement="top" class="tooltips fa fa-linkedin circle-icon circle-small"></i></a></span>
										</div>
										<h3>Adele Maitland</h3>
										<div>
											Art Director
										</div>
										<div itemprop="description" class="team-member-description">
						...
						<div class="col-md-12">
							<div class="row">
								<ul class="team-list animate-group">
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/team-6.jpg" alt="" data-animation-options='{"animation":"fadeInRight", "duration":"300"}'>
											<span class="image-overlay"> <a target="_blank" href="http://www.facebook.com"><i data-original-title="Facebook" data-placement="top" class="tooltips fa fa-facebook circle-icon circle-small"></i></a> <a target="_blank" href="http://www.linkedin.com"><i data-original-title="Linkedin" data-placement="top" class="tooltips fa fa-linkedin circle-icon circle-small"></i></a></span>
										</div>
										<h3>Kenneth Ross</h3>
										<div>
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/team-7.jpg" alt="" data-animation-options='{"animation":"fadeInRight", "duration":"300"}'>
											<span class="image-overlay"><a target="_blank" href="http://www.linkedin.com"><i data-original-title="Linkedin" data-placement="top" class="tooltips fa fa-linkedin circle-icon circle-small"></i></a></span>
										</div>
										<h3>Nicole Bell</h3>
										<div>
											Content Designer
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/team-8.jpg" alt="" data-animation-options='{"animation":"fadeInRight", "duration":"300"}'>
											<span class="image-overlay"> <a target="_blank" href="http://www.facebook.com"><i data-original-title="Facebook" data-placement="top" class="tooltips fa fa-facebook circle-icon circle-small"></i></a> <a target="_blank" href="http://www.linkedin.com"><i data-original-title="Linkedin" data-placement="top" class="tooltips fa fa-linkedin circle-icon circle-small"></i></a></span>
										</div>
										<h3>John Davis</h3>
										<div>
